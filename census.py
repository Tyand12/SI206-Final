...
cities = {
    ...
    'Starkville': ('69800', '28', 'MS'),
    'Missoula': ('49800', '30', 'MT'),
    'Brookings': ('07580', '46', 'SD'),
    'Vermillion': ('67020', '46', 'SD'),
    'Murray': ('54472', '21', 'KY'),
    'Hattiesburg': ('31040', '28', 'MS'),
    'Valdosta': ('78256', '13', 'GA'),
    'Hilo': ('14650', '15', 'HI'),
    'Grand Forks': ('32060', '38', 'ND'),
    'Fargo': ('25700', '38', 'ND'),
    'Carbondale': ('11140', '17', 'IL'),
    'Normal': ('53567', '17', 'IL'),
    'Cape Girardeau': ('11292', '29', 'MO'),
    'Terre Haute': ('75266', '18', 'IN'),
    'Huntington': ('40052', '54', 'WV'),
    'Bowling Green': ('09060', '21', 'KY'),
    'Johnson City': ('38400', '47', 'TN')
}
